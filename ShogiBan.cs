...
namespace BookEditor
{
    public partial class ShogiBan : Form
    {
        ...
        public ShogiBan()
        {
            ...
            ReviewHandPiece("-");
            clsBook.BookRead();
            txtBoxSfen.Text = "lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL";
        }
        ...
        // sfen 2016/06/04 山内変更　出力ボタンとSFENレコード出力機能追加
        // レコード読み込んでいないときは非表示
        private void btnOutRec_Click(object sender, EventArgs e)
        {
            ...
            {
                btnOutRec.Visible = true;
                string filePath = "D:/BookEditor/bin/Debug/newbook.db";
                string strKaigyo = "\r\n";
                string strSpace = " ";
